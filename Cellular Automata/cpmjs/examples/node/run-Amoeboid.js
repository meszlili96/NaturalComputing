...
let config = {
	...
	conf : {
		...
		V : [0,100,250],                   // Target volume of each cellkind

		// PerimeterConstraint parameters
		LAMBDA_P : [0,2,100],				    // PerimeterConstraint importance per cellkind
		P : [0,140,150],					    // Target perimeter of each cellkind

		// ActivityConstraint parameters
		LAMBDA_ACT : [0,2000,0],			    // ActivityConstraint importance per cellkind
